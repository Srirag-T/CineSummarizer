...
if __name__ == "__main__":
    print("Hello World")
    summary_template = """
    Given information about {movie} movie, talk about these things:
        1. Summary of the movie
        2. Cast of the movie
    """
    summary_prompt_template = PromptTemplate(input_variables=["movie"], template=summary_template);

    llm = ChatOllama(model="llama3")

    chain = summary_prompt_template | llm | StrOutputParser()

    res = chain.invoke(input={"movie":movie})
